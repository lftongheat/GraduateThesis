% Generates data to test LASSO phase transition with noise
clear all;
...
for di = 1:length(deltaArr)
    ...
    for ki = 1:length(rhoArr)
        ...
        for ti = 1:numTrials
            ...
            y = A*x+zn;
            [xhat, iters, activationHist] = SolveLasso(A, y, length(y), 'lasso');
    ...
    save LASSOPhaseData-N200z16.mat n deltaArr rhoArr zArr di ki numTrials ErrVecL0 ErrVecL2 ErrVecL2n
end
end
